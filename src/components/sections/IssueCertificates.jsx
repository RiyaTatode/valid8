    ...
    if (step === 1) {
      return (
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          >
            <svg className="w-16 h-16 text-indigo-600 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="flex-1 p-6 md:p-10 transition-all duration-300">
        <header className="mb-6 md:mb-10">
          ...
          <p className="text-gray-600 mt-2">
            {step === 1 ? 'Choose an issuance method to begin.' : 'Complete the steps to issue new certificates.'}
          </p>
        </header>
