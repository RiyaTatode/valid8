...
//     setLoading(true);
//     setCurrentStep(2); // Upload done → Extraction starts
...
//               <div
//                 className={`w-16 h-1 mx-4 rounded transition-all duration-700 ${
